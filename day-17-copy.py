# from https://github.com/alcatrazEscapee/AdventofCode/blob/master/2018/src/day17.py
...
def simulate():
    ...
    lowest_x, highest_x = min(p.x for p in clay), max(p.x for p in clay)
    ...
    # Output
    print_map(clay, flowing, still, x1=lowest_x-1, x2=highest_x+1, y2=lowest_y+1)
