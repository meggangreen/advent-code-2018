"""
    I definitely just copied this from https://github.com/MasterMedo/aoc/blob/master/2018/day/6.py
    it goes beyond my skill in map-making and programming.
"""
...
data = [map(int, i.split(', ')) for i in open('day-06.txt').readlines()]
